...
public class FileEx2 {
	...
	public static void main(String[] args) throws Exception {
		...
		// (원본)파일 : score.txt
		// (사본)파일 : out.txt
		String fileName1 = "C:/soldeskjava/workspace/oopjava/src/oop20230807/score.txt";
		String fileName2 = "C:/soldeskjava/workspace/oopjava/src/oop20230807/out.txt";
