function checkUpdateValid(){
	...
	let m_id = document.update.m_id; 
	let m_password = update.update.m_password; 
	let m_password2 = document.update.m_password2; 
	let m_name = document.update.m_name; 
	let m_phonenum = document.update.m_phonenum; 
	let m_photo = document.update.m_photo;
