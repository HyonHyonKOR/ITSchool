function checkJoinValid(){
	...
	let m_id = document.join.m_id; 
	let m_password = document.join.m_password; 
	let m_password2 = document.join.m_password2; 
	let m_name = document.join.m_name; 
	let m_phonenum = document.join.m_phonenum; 
	let m_photo = document.join.m_photo;
